    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            style={{ width: "100%", paddingLeft: "45px", marginLeft: "25px" }}
          >
            <div
              style={{
                width: "90%",
        ...
        >
          ...
          >
            {" "}
            {item.status === "Pending" ? null : "by " + item.respondent}{" "}
          </p>
            ...
            {item.status === "Closed" ? null : (
              <button
                style={{
                  ...
                  color: "#ffffff",
                  backgroundColor:
                    item.status === "Pending" ? "#2575c0" : "#57e031",
                  border: "none",
                  borderRadius: "8px",
                  margin: "5px",
                  marginTop: "20px",
      ...
      >
        {success ? (
          ...
          >
            <img
              style={{ width: "150px" }}
              src="https://img.icons8.com/external-flat-02-chattapat-/500/000000/external-success-business-management-flat-02-chattapat-.png"
            />
            <p
              style={{
                marginTop: "3px",
            ...
            >
              <button
                style={{
                  ...
                  marginTop: "20px",
                  boxShadow:
                    "0 1px 2px 0 rgba(0, 0, 0, 0.2), 0 1px 4px 0 rgba(0, 0, 0, 0.19)",
                }}
                type="button"
                onClick={() => {
                  // logic
              ...
              >
                {" "}
                <p style={{ display: "inline" }}> Submit </p>{" "}
              </button>
              <button
                style={{
                  paddingLeft: "15px",
